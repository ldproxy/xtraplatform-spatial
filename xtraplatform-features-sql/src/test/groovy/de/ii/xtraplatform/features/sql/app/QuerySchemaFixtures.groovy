...
class QuerySchemaFixtures {
    ...
    static List<SchemaSql> LONG_VALUE_PATH_OVERLAP = [
            new ImmutableSchemaSql.Builder()
                    .name("o400001")
                    ...
                    .addProperties(new ImmutableSchemaSql.Builder()
                            ...
                            .addProperties(new ImmutableSchemaSql.Builder()
                                    ...
                                    .type(Type.STRING)
                                    .parentPath(["o400001", "[id=rid]o400001__gem"])
                                    .sortKey("id")
                                    .build())
                            .addProperties(new ImmutableSchemaSql.Builder()
                                    .name("o73005")
                                    ...
                                    .addProperties(new ImmutableSchemaSql.Builder()
                                            ...
                                            .sourcePath("gemeinde_bezeichnung")
                                            .type(Type.STRING)
                                            .parentPath(["o400001", "[id=rid]o400001__gem", "[_ko_sch_gem=sch]o73005"])
                                            .sortKey("id")
                                            .build())
                                    .build())
                            .build())
