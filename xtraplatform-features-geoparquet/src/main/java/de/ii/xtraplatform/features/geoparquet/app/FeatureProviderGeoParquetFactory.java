...
public class FeatureProviderGeoParquetFactory
  ...
  @Inject
  public FeatureProviderGeoParquetFactory(
      Lazy<Set<SchemaFragmentResolver>> schemaResolvers,
      ProviderGeoParquetFactoryAssisted providerGeoParquetFactoryAssisted) {
    super(providerGeoParquetFactoryAssisted);
  ...
  public Optional<String> subType() {
    return Optional.of(FeatureProviderGeoParquet.ENTITY_SUB_TYPE);
  }

  @Override
  public Class<? extends PersistentEntity> entityClass() {
    return FeatureProviderGeoParquet.class;
  }
  ...
  @AssistedFactory
  public interface ProviderGeoParquetFactoryAssisted
      extends FactoryAssisted<FeatureProviderDataV2, FeatureProviderGeoParquet> {
    @Override
    FeatureProviderGeoParquet create(FeatureProviderDataV2 data);
  }
}
