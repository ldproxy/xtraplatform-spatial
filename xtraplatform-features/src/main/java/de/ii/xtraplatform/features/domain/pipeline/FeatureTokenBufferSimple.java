...
public class FeatureTokenBufferSimple<U, V, W extends ModifiableContext<U, V>>
    implements FeatureEventHandlerSimple<U, V, W> {

  private final FeatureEventHandlerSimple<U, V, W> downstream;
  private final List<Object> buffer;
  private final FeatureEventHandlerSimple<U, V, W> bufferIn;
  private final FeatureTokenReaderSimple<U, V, W> bufferOut;
