...
public class WFS extends VersionedVocabulary {
  ...
  static {
    ...
    addWord(VERSION._1_0_0, OPERATION.GET_FEATURE, "GetFeature");
    addWord(VERSION._1_0_0, OPERATION.GET_CAPABILITES, "GetCapabilities");
    addWord(VERSION._1_0_0, OPERATION.DESCRIBE_FEATURE_TYPE, "DescribeFeatureType");
    addWord(VERSION._1_0_0, OPERATION.GET_PROPERTY_VALUE, "GetPropertyValue");
