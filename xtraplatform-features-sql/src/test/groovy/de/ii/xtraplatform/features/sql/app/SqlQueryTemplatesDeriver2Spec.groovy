...
class SqlQueryTemplatesDeriver2Spec extends Specification {
    ...
    def 'value query templates: #casename'() {
        ...
        "simple filter scoped queryable"              | td      | 0     | 0      | []                      | null                                                                                                                        | "simple_filter_scopes"                  || "simple_filter_scopes"
        "simple filter scoped queryable + filter"     | td      | 0     | 0      | []                      | Eq.of(Property.of("planid"), ScalarLiteral.of("foo"))                                                                       | "simple_filter_scopes"                  || "simple_filter_scopes_filter"
        "value array"                                 | td      | 0     | 0      | []                      | null                                                                                                                        | "value_array"                           || "value_array"
        "object array"                                | td      | 0     | 0      | []                      | null                                                                                                                        | "object_array"                          || "object_array"
        "join with sortKey"                           | td      | 0     | 0      | []                      | null                                                                                                                        | "join_sortKey"                          || "join_sortKey"
        "join with sortKey + paging"                  | td      | 10    | 10     | []                      | null                                                                                                                        | "join_sortKey"                          || "join_sortKey_paging"
