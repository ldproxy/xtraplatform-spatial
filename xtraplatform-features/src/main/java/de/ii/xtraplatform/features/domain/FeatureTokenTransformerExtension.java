 ...
 * wires their transformers in immediately after {@code FeatureTokenTransformerLinkRoles}, before
 * the per-format value-transformation step. This is the right slot for transformers that need to
 * see raw provider values (pre-format) and rewrite tokens in-place.
 */
