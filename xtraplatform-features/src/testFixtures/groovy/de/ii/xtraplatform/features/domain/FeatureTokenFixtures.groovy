...
class FeatureTokenFixtures {
    ...
    public static final List<Object> SINGLE_FEATURE_POINT = [
            ...
            ["geometry"],
            Point.of(8.18523495507722, 49.698295103021096, OgcCrs.CRS84),
            FeatureTokenType.VALUE,
            ["kennung"],
            "611320001-1",
            Type.STRING,
    ...
    public static final List<Object> SINGLE_FEATURE_MULTI_POINT = [
            ...
            FeatureTokenType.GEOMETRY,
            ["geometry"],
            MultiPoint.of(List.of(Point.of(6.406233970262905, 50.1501333536934, OgcCrs.CRS84), Point.of(7.406233970262905, 51.1501333536934, OgcCrs.CRS84)), Optional.of(OgcCrs.CRS84)),
            FeatureTokenType.VALUE,
            ["kennung"],
            "580410003-1",
            Type.STRING,
    ...
    public static final List<Object> COLLECTION = [
            ...
            FeatureTokenType.GEOMETRY,
            ["geometry"],
            Point.of(6.295202392345018, 50.11336914792363, OgcCrs.CRS84),
            FeatureTokenType.VALUE,
            ["kennung"],
            "580340001-1",
            Type.STRING,
            ...
            FeatureTokenType.GEOMETRY,
            ["geometry"],
            MultiPoint.of(List.of(Point.of(6.406233970262905, 50.1501333536934, OgcCrs.CRS84)), Optional.of(OgcCrs.CRS84)),
            FeatureTokenType.VALUE,
            ["kennung"],
            "631510001-1",
            Type.STRING,
