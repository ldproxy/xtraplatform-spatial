...
class FeatureMutationsSqlSpec extends Specification {
    ...
    def 'createInserts'() {
        ...
        FeatureMutationsSql inserts = Spy(new FeatureMutationsSql(new SqlInsertGenerator2(OgcCrs.CRS84, null, new ImmutableSqlPathDefaults.Builder().build()),new ImmutableSqlPathDefaults.Builder().build()))
    ...
    def 'createInserts: merge'() {
        ...
        FeatureMutationsSql inserts = new FeatureMutationsSql(generator, null)
